  ...
  return (
    <main className='p-4'>
        <div className="projects flex flex-wrap gap-3">
          <button value={isModalOpen} onClick={()=>setIsModalOpen(true)} className="project p-4 border border-slate-300 rounded-md">
            New Project <i className="mt-2 ri-link"></i>
          </button>
            ...
            project.map((project)=>(
              <div key={project._id} onClick={() => {navigate(`/project`,{state: {project}})}} className='project flex flex-col gap-2 cursor-pointer p-4 border border-slate-300 rounded-md min-w-52 hover:bg-slate-200'>
                ...
                <div className='flex justify-between'>
                  ...
                  <div><i className="text-xl text-red-500 ri-delete-bin-line"></i></div>
                </div>
              </div>
            ))
          }
